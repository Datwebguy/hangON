(function () {
  ...
  function showLogin() {
    return new Promise((resolve, reject) => {
      ...
      title.textContent = 'Operator sign in';
      const description = document.createElement('p');
      description.textContent = 'Enter the operator token configured for this HangON workspace. The token is sent only to the HangON server and is not stored in the browser.';
      ...
      input.required = true;
      input.placeholder = 'Enter your workspace token';
      ...
      note.textContent = 'Protected workspace';
